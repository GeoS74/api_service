<h1>Получение списка заявок на ремонт</h1>
<hr>
<p>Метод предназначен для получения списка заявок на ремонт. <br>С помощью данного метода возможно запросить только те заявки, которые не были подтверждены Исполнителем.
    Для этого в строке запроса необходимо указать параметр: <b>only_new=true</b>
</p>

<h3 class="mt-4">Запрос метода</h3>
<p>Для получения всего списка заявок необходимо отправить <b>GET</b>-запрос на URL: <a href="<?php echo DOMEN.BASE.PREFIX ?>/orders"><?php echo DOMEN.BASE.PREFIX ?>/orders</a></p>
<p>Для получения списка не подтвержденных Исполнителем заявок необходимо отправить <b>GET</b>-запрос на URL: <a href="<?php echo DOMEN.BASE.PREFIX ?>/orders"><?php echo DOMEN.BASE.PREFIX ?>/orders?only_new=true</a></p>
...
[
    ...
    {
        "uid": "dft95ry5r9eyr89320304b5t305u39",
        "date_create": "2022-03-21 08:05:01",
        ...
    },
    ...
]</pre>
...
<p>В случае успешного ответа возращает статус страницы <b>200</b>.</p>